...
var rev=row.className.indexOf('pm-rev')>-1,set=row.querySelector('.pm-set'),hold=false,rt=null,on=false,ww=0;
function w(){return ww>0?ww:(ww=set?set.offsetWidth:0);}
window.addEventListener('resize',function(){ww=0;});
