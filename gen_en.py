...
{"path":"/en/services/metal-fence/","name":"Corrugated (metal) fences","hero":"luxaed-svc-profnastil","og":"/img/luxaed-svc-profnastil.jpg",
 ...
 "faq":[("Won't the sheet fade?","Quality sheet with a polymer coating keeps its colour for a long time. We use proven materials."),
        ...
        ("Is profiled sheet cheaper than wood and mesh?","Usually yes. It's one of the most affordable options. We'll give an exact price after the measurement."),("Do you build modular fences (moodulaed)?","Yes. Our profiled-sheet and panel fences are moodulaed: ready modular sections and posts that install fast and neatly.")]},
