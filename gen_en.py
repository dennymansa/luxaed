...
{"path":"/en/services/mesh-fence/","name":"Mesh & 3D fences","hero":"luxaed-svc-mesh","og":"/img/luxaed-svc-mesh.jpg",
 ...
 "kicker":"3D mesh · panels · posts","h1":"Mesh &amp; 3D<br><em>fences</em><br>in Tallinn",
 ...
 "intro_h":"Why a 3D fence","intro_p":"A welded panel with bends (3D) holds its shape without sagging or wind load and looks modern. A great fit for houses, townhouses and grounds. We also sell and install fence posts and build dog runs.",
...
{"path":"/en/services/wooden-fence/","name":"Wooden fences","hero":"luxaed-svc-wood","og":"/img/luxaed-svc-wood.jpg",
 ...
 "kicker":"Wood · steel frame","h1":"Wooden<br><em>fences</em><br>in Tallinn",
...
{"path":"/en/services/metal-fence/","name":"Corrugated (metal) fences","hero":"luxaed-svc-profnastil","og":"/img/luxaed-svc-profnastil.jpg",
 "title":"Metal, corrugated & steel picket fences in Tallinn — LuxAed","desc":"Installation of corrugated (profiled-sheet), steel picket, wrought-iron and concrete/block fences in Tallinn and Harjumaa. Galvanised sheet and picket, various colours. Affordable and fast. Free measurement.",
 "kicker":"Corrugated · steel picket · metal","h1":"Metal &<br><em>corrugated fences</em><br>in Tallinn",
 "lead":"A practical solution: a solid fence from galvanised profiled sheet, or a modern steel picket (euro-picket) with light gaps. Full privacy or an open look, protection from wind and dust, various colours.",
 "intro_h":"Why a metal fence","intro_p":"Profiled sheet is inexpensive and quick to install, while a steel picket looks modern and lets light through. Both last thanks to galvanising and a polymer coating.",
 "bens":["Full privacy — a solid sheet fence","Galvanised sheet with polymer coating","Steel picket (euro-picket) with set gaps","Protection from wind, dust and noise","Wrought-iron and decorative details","Concrete & block fences for a solid wall"],
 "variants_h":"Metal fence options",
 "variants":[("▦","Profiled sheet","A solid fence from galvanised profiled sheet at the required height."),
             ("▤","Steel picket","Steel picket (euro-picket) — modern and open, with an adjustable gap."),
             ("❦","Wrought iron","Forged elements and decorative metal for gates and fences — made to order."),
             ("▣","Concrete & block","A solid wall for privacy, with brick or block posts.")],
 "cta_band":"Let's price a metal fence","incl":["On-site measurement","Installing steel posts and rails","Mounting the sheet or picket","Levelling","Post-installation check"],
 "factors":["Fence length and height","Type (sheet, picket, wrought iron, concrete)","Coating grade and colour","Post type (metal, brick, block)","Gates, wickets, terrain and groundwork"],
 ...
 "faq":[("Do you install steel picket (euro-picket) fences?","Yes — a modern fence with an adjustable gap, galvanised and powder-coated. Works for both the fence line and gates."),
        ("Won't the sheet fade?","Quality sheet with a polymer coating keeps its colour for a long time. We use proven materials."),
...
{"path":"/en/services/fence-repair/","name":"Fence & gate repair","hero":"luxaed-g6","og":"/img/luxaed-g6.jpg",
 ...
 "kicker":"Repair · maintenance","h1":"Fence &amp; gate<br><em>repair</em><br>in Tallinn",
