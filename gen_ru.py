...
def gtypes_html(items): return '<div class="gtypes">'+"".join(f'<div class="gtype"><div class="gtype-img"><picture><source type="image/webp" srcset="/img/{im}.webp"><img src="/img/{im}.jpg" alt="{html.escape(a)}" width="640" height="480" loading="lazy"></picture></div><div class="gtype-txt"><h3>{t}</h3><p>{d}</p></div></div>' for im,a,t,d in items)+'</div>'
...
SERVICES=[
{
 ...
 "types":[("luxaed-w-mesh-1","Антрацитовый 3D-панельный забор","3D сварная панель","Панель с V-образными рёбрами жёсткости — они дают прочность и современный объёмный вид. Самый прочный и популярный вариант: не провисает и не гнётся на ветру. Подходит для частных домов, таунхаусов и территорий."),
          ("luxaed-w-panels","2D-панели перед монтажом","2D сварная панель","Плоская панель с двойным горизонтальным прутком (два прутка в ряд). Прочная и дешевле 3D — хороший выбор для длинных участков и больших площадей.")],
...
},
{
 ...
 "types":[("luxaed-w-gates-auto","Откатные ворота с автоматикой","Откатные ворота","Сдвигаются вбок и не занимают место при открытии — идеальны, когда перед въездом мало места. Консольная конструкция без нижней направляющей, подходит как въездные ворота. Заполнение: дерево, профнастил, штакетник или сварная панель."),
          ("luxaed-w-gates-green","Распашные ворота из сварных панелей","Распашные ворота","Классические двустворчатые ворота — проще и дешевле, если перед въездом есть место для открытия створок. Подходят под любой забор и автоматику."),
          ("luxaed-gate-closeup-1","Калитка с деревянным заполнением и замком","Калитка","Калитка для прохода в одном стиле с забором. Механический замок или электрозамок с домофоном и вызывной панелью. Надёжно и удобно каждый день."),
          ("luxaed-gate-hardware-1","Ролики и каретки откатных ворот","Фурнитура ворот","Качественные ролики, каретки, петли и замки. Оцинкованные детали, которые держат эстонский климат и годами обеспечивают плавный ход.")],
 "variants_h":"Типы автоматики ворот",
 "variants":[("⚙","Автоматика откатных ворот","Привод по весу ворот, пульт ДУ и фотоэлементы. Плавное открытие и остановка."),
             ("⚙","Автоматика распашных ворот","Рычажные или винтовые приводы на обе створки. Тихая и плавная работа."),
             ("⊤","Шлагбаумы","Автоматические шлагбаумы для парковок, ЖК и въездов на территорию."),
             ("🚪","Автоматика гаражных ворот","Приводы и пульты для секционных гаражных ворот, связь с общей системой."),
             ("🔔","Домофон и видеопанель","Вызывные панели с открытием ворот и калитки, видео и дистанционное управление.")],
