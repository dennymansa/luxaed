...
},
{
 ...
 "gallery":[("luxaed-w-gates-auto","Откатные ворота с автоматикой"),("luxaed-w-gates-green","Распашные ворота из сварных панелей"),("luxaed-w-gates-graphite","Графитовые распашные ворота"),("luxaed-w-gates-winter","Откатные ворота, монтаж зимой"),("luxaed-w-gates-night","Ворота вечером"),("luxaed-w-gates-picket","Откатные ворота из штакетника"),("luxaed-w-lock-black","Замок и ручка калитки"),("luxaed-w-mesh-gate","Калитка из панели"),("luxaed-w-auto-close","Привод откатных ворот и фотоэлемент"),("luxaed-w-van","LuxAed на объекте")],
