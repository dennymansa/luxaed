...
SERVICES=[
{
 ...
 "desc":"Установка сетчатых и 3D-заборов из сварных панелей в Таллинне и Харьюмаа. Оцинковка + порошковая окраска, антрацит RAL 7016, заборные столбы, вольеры для собак и монтаж под ключ. Бесплатный замер.",
...
},
{
 ...
 "desc":"Установка заборов из профнастила в Таллинне и Харьюмаа. Оцинкованный профлист, ковка, бетонные и блочные заборы, разные цвета, глухой забор для приватности. Практично и доступно. Бесплатный замер.",
...
},
{
 ...
 "desc":"Металлический штакетник (евроштакетник) в Таллинне и Харьюмаа: современный забор с регулируемым просветом, оцинкованный и с полимерным покрытием. Забор и ворота в едином стиле. Бесплатный замер.",
...
{
 "path":"/ru/uslugi/vorota-kalitki/","name":"Ворота, калитки и автоматика","hero":"luxaed-w-gates-auto","og":"/img/luxaed-w-gates-auto.jpg",
 "title":"Ворота, калитки и автоматика в Таллинне — LuxAed",
 "desc":"Откатные и распашные ворота, калитки, автоматика ворот, шлагбаумы и домофоны в Таллинне и Харьюмаа. Установка приводов, пультов и домофонов под ключ. Бесплатный замер.",
