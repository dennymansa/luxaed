...
},
{
 ...
 "types":[("luxaed-w-gates-auto","Откатные ворота с автоматикой","⇄","Тип ворот","Откатные ворота","Консольная конструкция, которая сдвигается вбок без нижней направляющей и не занимает место при открытии. Идеальны как въездные, когда перед ними мало места.",["Без нижней направляющей","С автоматикой","Дерево / профнастил / панель"]),
          ...
          ("luxaed-gate-closeup-1","Калитка с деревянным заполнением и замком","🚶","Тип ворот","Калитка","Проходная дверца в одном стиле с забором. Механический замок или электрозамок с домофоном и вызывной панелью.",["Для прохода","Замок / электрозамок","В стиле забора"]),
