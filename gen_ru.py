...
},
{
 ...
 "variants_h":"Ворота и автоматика — все типы",
 "variants":[("⇄","Откатные ворота","Сдвижные ворота без нижней направляющей. Не занимают место при открытии. Идеальны для въезда."),
             ("⛩","Распашные ворота","Классические двустворчатые ворота. Подходят для широкого въезда, дешевле."),
             ("🚶","Калитка","Калитка с замком или электрозамком, в одном стиле с забором."),
             ("⚙","Автоматика откатных ворот","Привод по весу ворот, пульт ДУ и фотоэлементы. Плавное открытие."),
             ("⚙","Автоматика распашных ворот","Рычажные или винтовые приводы на обе створки. Плавный старт и стоп."),
 ...
 "gallery":[("luxaed-w-gates-auto","Откатные ворота с автоматикой"),("luxaed-w-gates-green","Распашные ворота из сварных панелей"),("luxaed-w-gates-graphite","Графитовые распашные ворота"),("luxaed-w-gates-winter","Откатные ворота, монтаж зимой"),("luxaed-w-gates-night","Ворота вечером"),("luxaed-w-gates-picket","Откатные ворота из штакетника"),("luxaed-w-lock-black","Замок и ручка калитки"),("luxaed-w-mesh-gate","Калитка из панели"),("luxaed-gate-closeup-1","Калитка с деревом и замком"),("luxaed-auto-2","Привод откатных ворот"),("luxaed-gate-hardware-1","Ролики и каретки откатных ворот"),("luxaed-w-van","LuxAed на объекте")],
