...
{footer("ru")}
<div class="mob-bar"><a href="tel:{TEL}" class="btn btn-ghost">Позвонить</a><a href="#form" class="btn btn-accent">Заявка</a></div>
{SCRIPTS}
</body></html>'''
    fp=write(c["path"], H+"\n"+body)
    print("wrote", fp)
...
SERVICES=[
{
 ...
 "kicker":"3D-сетка · сварные панели","h1":"Сетчатые и 3D-заборы в Таллинне",
...
},
{
 ...
 "kicker":"Дерево · стальной каркас","h1":"Деревянные заборы в Таллинне",
...
},
{
 ...
 "kicker":"Профнастил · профлист","h1":"Заборы из профнастила в Таллинне",
...
},
{
 ...
 "kicker":"Ворота · автоматика · домофоны","h1":"Ворота, калитки и автоматика в Таллинне",
...
},
{
 ...
 "kicker":"Ремонт · обслуживание","h1":"Ремонт заборов и ворот в Таллинне",
