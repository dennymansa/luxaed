...
SERVICES=[
{
 ...
 "kicker":"3D-сетка · панели · столбы","h1":"Сетчатые<br><em>и 3D-заборы</em><br>в Таллинне",
...
},
{
 ...
 "title":"Забор из профнастила и металлический штакетник в Таллинне — LuxAed",
 "desc":"Установка заборов из профнастила и металлического штакетника в Таллинне и Харьюмаа. Оцинкованный профлист и штакетник, ковка, бетонные и блочные заборы, разные цвета. Практично и доступно. Бесплатный замер.",
 "kicker":"Профнастил · штакетник · металл","h1":"Забор из профнастила<br>и <em>штакетника</em><br>в Таллинне",
 "lead":"Практичное решение: глухой забор из оцинкованного профлиста или современный металлический штакетник. Полная приватность или лёгкие просветы, защита от ветра и пыли, разные цвета.",
 "intro_h":"Почему металлический забор","intro_p":"Профлист — недорогой и быстрый в монтаже, а металлоштакетник выглядит современно и пропускает свет. Оба служат долго за счёт оцинковки и полимерного покрытия.",
 "bens":["Полная приватность — глухой профлист","Оцинкованный лист с полимерным покрытием","Металлический штакетник (евроштакетник)","Защита от ветра, пыли и шума","Ковка и декоративные элементы на заказ","Бетонные и блочные заборы — массивная стена"],
 "variants_h":"Варианты металлического забора",
 "variants":[("▦","Профнастил","Глухой забор из оцинкованного профлиста нужной высоты."),
             ("▤","Металлоштакетник","Металлический штакетник (евроштакетник) — современно, с регулируемым просветом."),
 ...
 "cta_band":"Рассчитаем металлический забор",
 "incl":["Выезд на замер участка","Установка металлических столбов и лаг","Монтаж профлиста или штакетника","Выравнивание по уровню","Проверка конструкции после монтажа"],
 "factors":["Длина и высота забора","Тип (профлист, штакетник, ковка, бетон)","Марка и цвет покрытия","Тип столбов (металл, кирпич, блок)","Ворота и калитки, рельеф и основание"],
 ...
 "faq":[("Делаете металлический штакетник (евроштакетник)?","Да, монтируем металлический штакетник — современная ограда с регулируемым просветом, оцинкованная и с полимерным покрытием. Подходит и для забора, и для ворот."),
        ("Профнастил не выгорает?","Качественный профлист с полимерным покрытием долго сохраняет цвет. Подбираем проверенные материалы."),
        ...
        ("Можно комбинировать со столбами из кирпича?","Да, делаем комбинированные заборы: профлист или штакетник между кирпичными или блочными столбами."),
        ("Профнастил дешевле дерева и 3D-сетки?","Как правило да — это одно из самых доступных решений. Точную цену назовём после замера.")],
},
{
 "path":"/ru/uslugi/shtaketnik/","name":"Металлический штакетник","hero":"luxaed-metal","og":"/img/luxaed-metal.jpg",
 ...
 "kicker":"Штакетник · металл","h1":"Металлический<br><em>штакетник</em><br>в Таллинне",
 ...
 "gallery":[("luxaed-metal","Металлический забор с воротами"),("luxaed-g3","Металлический забор вечером"),("luxaed-profnastil-2","Металлический забор (пример)")],
...
},
{
 ...
 "kicker":"Ворота · автоматика · шлагбаумы","h1":"Ворота, калитки<br><em>и автоматика</em><br>в Таллинне",
