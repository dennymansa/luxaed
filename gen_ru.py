...
SERVICES=[
{
 ...
 "types":[("luxaed-w-mesh-1","Антрацитовый 3D-панельный забор","3D","Панель","3D сварная панель","3D-панель — это сварная панель с V-образными рёбрами жёсткости, которые дают прочность и объёмный вид. Самый прочный и популярный вариант: не провисает и не гнётся на ветру.",["V-рёбра жёсткости","Самая прочная","Антрацит RAL 7016"]),
          ("luxaed-w-panels","2D-панели перед монтажом","2D","Панель","2D сварная панель","2D-панель — это плоская панель с двойным горизонтальным прутком (два прутка в ряд). Прочная и дешевле 3D — хороший выбор для длинных участков.",["Двойной пруток","Дешевле 3D","Для длинных участков"])],
...
},
{
 ...
 "types":[("luxaed-profnastil-2","Забор из профнастила","▦","Тип забора","Забор из профнастила","Забор из профнастила — это глухой забор из оцинкованного листа с полимерным покрытием: полная приватность и защита от ветра, пыли и шума. Доступен в разных цветах, в том числе под дерево.",["Глухой, приватный","Оцинковка + полимер","Разные цвета"]),
          ("luxaed-concrete-tmp","Бетонный забор под камень","▣","Массивный забор","Бетонный и блочный забор","Бетонный и блочный забор — это массивная стена для приватности и шумозащиты: бетонные панели под камень или блочные столбы. Комбинируем с металлом, профлистом или ковкой.",["Массивная стена","Имитация камня","Защита от шума и ветра"]),
...
},
{
 ...
 "types":[("luxaed-w-lippaed-1","Графитовый металлический штакетник","▤","Тип штакетника","Металлический штакетник","Металлический штакетник — это ограждение из горизонтальных ламелей, которое пропускает свет и выглядит современно. Зазор между ламелями выбираете сами: реже для лёгкости или плотнее для приватности. Возможен одно- или двусторонний.",["Регулируемый зазор","Одно- или двусторонний","Оцинковка + порошок"]),
...
},
{
 ...
 "types":[("luxaed-w-gates-auto","Откатные ворота с автоматикой","⇄","Тип ворот","Откатные ворота","Откатные ворота — это консольная конструкция, которая сдвигается вбок без нижней направляющей и не занимает место при открытии. Идеальны как въездные, когда перед въездом мало места.",["Без нижней направляющей","С автоматикой","Дерево / профнастил / панель"]),
          ("luxaed-w-gates-green","Распашные ворота из сварных панелей","⛩","Тип ворот","Распашные ворота","Распашные ворота — это двустворчатые ворота, открывающиеся внутрь или наружу. Проще и дешевле, когда перед въездом есть место для створок.",["Две створки","Дешевле","Под любую автоматику"]),
          ("luxaed-gate-closeup-1","Калитка с деревянным заполнением и замком","🚶","Тип ворот","Калитка","Калитка — это проходная дверца в одном стиле с забором. Механический замок или электрозамок с домофоном и вызывной панелью.",["Для прохода","Замок / электрозамок","В стиле забора"]),
 ...
 "autotypes":[("luxaed-g9","Привод BFT откатных ворот","⚙","Автоматика","Автоматика откатных ворот","Автоматика откатных ворот — это привод, подобранный по весу и ширине ворот. В комплекте пульт ДУ, фотоэлементы и плавный старт.",["Привод по весу","Пульт и фотоэлементы","BFT / Nice / CAME"]),
              ("luxaed-g6","Рычажный привод распашных ворот","⚙","Автоматика","Автоматика распашных ворот","Автоматика распашных ворот — это рычажные или винтовые приводы на обе створки. Тихое, плавное открытие и остановка без рывков.",["Рычажный / винтовой","Тихая работа","На обе створки"]),
              ("luxaed-barrier-tmp","Автоматический шлагбаум на въезде","⊤","Автоматика","Шлагбаум","Шлагбаум — это автоматическая стрела для управления въездом или парковкой. Подходит для ЖК, парковок и территорий.",["Парковки и ЖК","Пульт или код","Быстрое открытие"]),
