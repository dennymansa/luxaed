...
<section class="section section--alt"><div class="wrap"><div class="equip">
  ...
  <div class="equip-img"><picture><source type="image/webp" srcset="/img/luxaed-w-crew.webp"><img src="/img/luxaed-w-crew.jpg" width="750" height="1000" alt="Artur Mustafin — LuxAed master craftsman on site" loading="lazy"></picture></div>
