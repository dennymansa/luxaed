...
<section class="section"><div class="wrap">
  ...
  <ul class="svc-bens">
    <li>Работаем <b>с 2021 года</b> в Таллинне и Харьюмаа</li>
...
<section class="section"><div class="wrap"><div class="equip">
  ...
  <div class="equip-img"><picture><source type="image/webp" srcset="/img/luxaed-w-crew.webp"><img src="/img/luxaed-w-crew.jpg" width="750" height="1000" alt="LuxAed — установка заборов и ворот" loading="lazy"></picture></div>
