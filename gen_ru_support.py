...
<section class="section"><div class="wrap"><div class="equip">
  ...
  <div class="equip-img"><picture><source type="image/webp" srcset="/img/luxaed-w-crew.webp"><img src="/img/luxaed-w-crew.jpg" width="750" height="1000" alt="Мастер LuxAed монтирует забор" loading="lazy"></picture></div>
  <div class="equip-body"><p class="lead" style="margin-bottom:14px">Артур строит заборы и ворота в Таллинне и Харьюмаа уже 15 лет. Он заранее знает, какое решение подойдёт вашему участку и как избежать лишних затрат.</p><ul class="svc-bens">
