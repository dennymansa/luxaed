...
# ---------- О НАС ----------
about_inner=f'''{hero("О компании","О компании LuxAed","Проектируем, изготавливаем и устанавливаем заборы, ворота и калитки в Таллинне и Харьюмаа — дерево, профнастил, сварная 3D-сетка, автоматика ворот и домофоны.", crumb="О нас")}
<section class="section"><div class="wrap">
  <span class="tag">Кто мы</span><h2 class="big">Производим и устанавливаем заборы и ворота в Таллинне и Харьюмаа</h2>
  <p class="lead">Мы специализируемся на изготовлении и установке заборов, ворот и калиток в Таллинне и Харьюмаа <b>с 2021 года</b>. Работаем с деревом, профнастилом и сварной 3D-сеткой, устанавливаем автоматику ворот и домофоны и выполняем ремонт существующих конструкций. Для каждого проекта подбираем решение с учётом участка, бюджета и пожеланий заказчика.</p>
  <p class="lead" style="margin-top:14px">Берём весь процесс на себя: приезжаем на бесплатный замер, закупаем материалы, устанавливаем и передаём готовый объект. По ходу работ держим вас в курсе. Стоимость называем заранее — без скрытых доплат и сюрпризов в счёте. И, в отличие от многих, <b>работаем круглый год, включая зиму</b>.</p>
</div></section>
...
<section class="section"><div class="wrap">
  <span class="tag">Почему LuxAed</span><h2 class="big">Что вы получаете</h2>
  <ul class="svc-bens">
...
page("/ru/o-nas/","О компании LuxAed — заборы и ворота в Таллинне","LuxAed — производство и установка заборов, ворот и калиток в Таллинне и Харьюмаа. Дерево, профнастил, 3D-сетка, автоматика ворот и домофоны. 100% рекомендуют в Facebook.", about_inner)
