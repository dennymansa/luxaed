...
def hero(kicker, h1, lead, img="luxaed-wide-wood", crumb=None):
  ...
  <div class="wrap">{cr}
    ...
    <h1>{h1}</h1>
    <p class="lead">{lead}</p>
    <div class="hero-btns"><a class="btn btn-accent" href="/kontakty/#form">Оставить заявку →</a><a class="btn btn-ghost" href="tel:{TEL}">Позвонить {PHONE}</a></div>
  </div>
</section>'''
...
# ---------- О НАС ----------
about_inner=f'''{hero("О компании","О компании LuxAed","Мы производим и устанавливаем заборы, ворота и калитки в Таллинне и Харьюмаа — дерево, профнастил, сварная 3D-сетка, автоматика ворот и домофоны.", crumb="О нас")}
<section class="section"><div class="wrap">
  <span class="tag">Кто мы</span><h2 class="big">Заборы и ворота — то, что мы делаем каждый день</h2>
  <p class="lead">LuxAed устанавливает заборы, ворота и калитки в Таллинне и Харьюмаа <b>с 2021 года</b>. Нам доверяют частные клиенты по всему региону, а на нашей странице в Facebook — <b>34 отзыва, 100% рекомендаций</b> и более 6100 подписчиков.</p>
  <p class="lead" style="margin-top:14px">Мы берём все работы на себя: приезжаем на бесплатный замер, закупаем материалы, устанавливаем и сдаём готовый объект. По ходу работ держим вас в курсе, что уже сделано и что дальше. Работаем аккуратно, по честной цене и называем стоимость до начала. И, в отличие от многих, <b>работаем круглый год — даже зимой</b>.</p>
  <ul class="svc-bens">
    <li>Работаем с 2021 года в Таллинне и Харьюмаа</li>
    <li>Заборы из дерева, профнастила и сварной 3D-сетки</li>
    <li>Откатные и распашные ворота, автоматика и домофоны</li>
    <li>Закупку материалов берём на себя</li>
    <li>Держим в курсе на каждом этапе работ</li>
    <li>Бесплатный замер и расчёт, гарантия на работы</li>
    <li>Работаем круглый год, включая зиму</li>
    <li>Ремонт и обслуживание существующих конструкций</li>
  </ul>
</div></section>
<section class="section section--dark" style="position:relative;overflow:hidden"><div style="position:absolute;inset:0;background:url('/img/luxaed-post-install-1.webp') center/cover no-repeat;opacity:.08"></div>
  ...
  <div class="nums">
    ...
    <div class="num"><b>6100<small>+</small></b><div class="t">Подписчиков</div><p>Следят за нашими работами</p></div>
...
<section class="cta-final"><div class="wrap"><h2>Обсудим <em>ваш забор или ворота</em>?</h2>
  ...
  <div class="hero-btns"><a class="btn btn-accent" href="/kontakty/#form">Оставить заявку →</a><a class="btn btn-ghost" href="tel:{TEL}">Позвонить {PHONE}</a></div></div></section>'''
page("/o-nas/","О компании LuxAed — заборы и ворота в Таллинне","LuxAed — производство и установка заборов, ворот и калиток в Таллинне и Харьюмаа. Дерево, профнастил, 3D-сетка, автоматика ворот и домофоны. 100% рекомендуют в Facebook.", about_inner)
...
<div class="hero-btns"><a class="btn btn-accent" href="/kontakty/#form">Оставить заявку →</a><a class="btn btn-ghost" href="tel:{TEL}">Позвонить {PHONE}</a></div></div></section>'''
page("/faq/","Вопросы и ответы о заборах и воротах — LuxAed","Частые вопросы о заборах, воротах и автоматике в Таллинне: цена, материалы, сроки, автоматика, ремонт. Ответы от LuxAed.", faq_inner, schema=faq_schema)
...
page("/kontakty/","Контакты LuxAed — заборы и ворота в Таллинне","Контакты LuxAed: телефон "+PHONE+", email "+EMAIL+", Facebook. Заборы, ворота и автоматика в Таллинне и Харьюмаа. Оставьте заявку на бесплатный замер.", contacts_inner)
...
legal_page("/privaatsus/","Политика конфиденциальности — LuxAed","Политика конфиденциальности","Конфиденциальность",[
...
legal_page("/tingimused/","Условия обслуживания — LuxAed","Условия обслуживания","Условия",[
