...
{"path":"/aiad/vorkaed/","name":"Võrkaed ja paneelaed","hero":"luxaed-svc-mesh","og":"/img/luxaed-svc-mesh.jpg",
 "title":"Võrkaed, paneelaed ja piirdeaed Tallinnas — LuxAed","desc":"Võrkaia, keevisvõrkaia ja keevispaneelaia (2D/3D aiapaneelid) paigaldus Tallinnas ja Harjumaal. Piirdeaed tsingitud ja pulbervärvitud paneelidest, antratsiit RAL 7016, postid ja paigaldus. Tasuta mõõdistus.",
 "kicker":"Võrkaed · paneelaed · piirdeaed","h1":"Võrk- ja<br><em>paneelaed</em><br>Tallinnas",
 ...
 "intro_h":"Miks valida paneelaed","intro_p":"Keevispaneel (3D) hoiab vormi, ei vaju ega tuuletõmba ning näeb kaasaegne välja. Selline piirdeaed sobib eramutele, ridaelamutele ja territooriumidele.",
 "bens":["Tugevad keevispaneelid jäikusribidega","Tsink + pulbervärv — ei roosteta","Antratsiit RAL 7016 ja teised värvid","Hea läbipaistvus, vähe tuulekoormust","2D ja 3D aiapaneelid, keevisvõrkaed","Piirdeaed eramule, ettevõttele, territooriumile"],
...
{"path":"/aiad/metallaed/","name":"Metallaed ja profiilplekk-aed","hero":"luxaed-svc-profnastil","og":"/img/luxaed-svc-profnastil.jpg",
 "title":"Metallaed, profiilplekk ja metall-lippaed Tallinnas — LuxAed","desc":"Metallaed, profiilplekk-aed ja metall-lippaed (štaketnik) Tallinnas ja Harjumaal. Tsingitud plekk ja lippaed, kunstsepis, betoon- ja plokkaed, erinevad värvid. Soodne ja kiire. Tasuta mõõdistus.",
 "kicker":"Metall · profiilplekk · lippaed","h1":"Metallaed ja<br><em>profiilplekk-aed</em><br>Tallinnas",
 "lead":"Praktiline ja soodne lahendus: kinnine aed tsingitud profiilplekist või kaasaegne metall-lippaed. Täielik privaatsus, tuule- ja tolmukaitse, erinevad värvid.",
 "intro_h":"Miks metallaed","intro_p":"Profiilplekk on soodne ja kiiresti paigaldatav, metall-lippaed aga kaasaegne ja läbipaistev. Mõlemad peavad kaua tänu tsingile ja polümeerkattele.",
 "bens":["Täielik privaatsus — kinnine aed","Tsingitud plekk polümeerkattega","Metall-lippaed (štaketnik) valitava vahega","Kaitse tuule, tolmu ja müra eest","Kunstsepis ja dekoratiivdetailid","Ka betoon- ja plokkaed massiivseks müüriks"],
 "variants_h":"Metallaia valikud",
 "variants":[("▦","Profiilplekk-aed","Kinnine aed tsingitud plekist vajalikus kõrguses."),
             ("▤","Metall-lippaed","Metallist lippaed (euro-lippaed) — kaasaegne ja läbipaistev, valitava vahega."),
 ...
 "faq":[("Kas teete metall-lippaeda (štaketniki)?","Jah, paigaldame metallist lippaeda — kaasaegne läbipaistev piire valitava vahega, tsingitud ja pulbervärvitud. Sobib nii aiale kui väravatele."),
        ("Kas profiilplekk ei pleegi?","Kvaliteetne polümeerkattega plekk hoiab värvi kaua. Kasutame tõestatud materjale."),
